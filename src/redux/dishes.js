...
export const Dishes = (state = {
    ...
    switch (action.type) {
        case ActionTypes.ADD_DISHES:
            // I'm just going to take the same state and then I can add, and so this is the sprint operator that I'm going to load in here. So, it will take the current value of the state and then whatever else that I passing in after this will be applied as modifications to the state. So again, the state itself will not be mutated, instead, I take the state, I create a new object from the original state and then make some changes to that object and then return that object.
            // the action.payload carries the dishes information. So in this case, I will set the dishes to action.payload.
